...
* In order for it to be truly useful to restore any kind of old pictures, the model needs to be trained on the entire greyscaled Imagenet dataset. Further, it should also be taught to learn different distortions or wear and tear that can occur as time passes and seek to revert that.
